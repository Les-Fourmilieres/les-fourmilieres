...
function RouteComponent() {
	return (
		<Section>
			...
			<p>Entrée à prix libre - Camping en auto-gestion sur place - Restauration et buvette.</p>

			<p>Pour sa 9ième édition, le festival des luttes populaires s'inscrit dans la programmation des fourmilières.</p>
